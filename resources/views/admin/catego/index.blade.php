...
<body>
    @if ($message)
    <div style="margin-top: -30px;" id="mail" class="alert alert-info">{{ $message }}</div>
@endif
    <div class="search-container">

        <form style="margin-top: 50px;" class="form-inline" action="{{ route('admin.catego.index') }}" method="GET">
...
<Div class="container mt-5">
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="{{ route('admin.catego.create') }}" class="btn btn-success" style="float: right;">Add specialite</a>
                <div class="card-header">Specialite List</div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <td> <a href="{{route('admin.catego.edit',$ap->id)}}" class="btn btn-warning"><i class="fas fa-edit"></i></a></td>
                                        <td>
                                            <form action="{{ route('admin.catego.delete', $ap->id) }}" method="POST">
                                                @csrf
                                                @method('POST')
