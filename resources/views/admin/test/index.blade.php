...
<body>
    ...
    <div class="search-container">
        ...
        <form style="margin-top: 50px;" class="form-inline" action="{{ route('admin.test.index') }}" method="GET">
...
<Div class="container mt-5">
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="{{ route('admin.test.create') }}" class="btn btn-success" style="float: right;">Add Test</a>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="course-item bg-light">
                    <div class="position-relative overflow-hidden">
                        <img class="img-fluid" style="height: 300px; width: 400px;" src="{{asset ('uploads/test')}}/{{$c->img}}" alt="">
                        <div class="w-100 d-flex justify-content-center position-absolute bottom-0 start-0 mb-4">
                            <a href="{{ route('admin.test.edit',$c->id) }}" class="flex-shrink-0 btn btn-sm btn-primary px-3 border-end" style="border-radius: 30px 0 0 30px;">Edit</a>
                            <form action="{{ route('admin.test.delete', $c->id) }}" method="POST">
                                    @csrf
                                    @method('POST')
                    ...
                    <div class="text-center p-4 pb-0">
                        ...
                        <h5 class="mb-4">{{$c->desc}}</h5>
                    </div>
                    <div class="d-flex border-top">
                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-user-tie text-primary me-2"></i>teste</small>
                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-clock text-primary me-2"></i>{{$c->course->name}} </small>
                        <small class="flex-fill text-center py-2"><i class="fa fa-user text-primary me-2"></i>{{$c->catego->name}}</small>
                    </div>
                </div>
            </div>
         @endforeach
...
<script src="sweetalert2.all.min.js"></script>
    ...
    @else
    <tr> <STrong> <p>test not found</p></tr></STrong> </TR>
      @endif
</body>
</html>
@endsection
