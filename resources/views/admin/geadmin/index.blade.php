...
<body>
    ...
    <div class="search-container">
        ...
        <form style="margin-top: 50px;" class="form-inline" action="{{ route('admin.geadmin.index') }}" method="GET">
...
<Div class="container mt-5">
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="{{ route('admin.geadmin.create') }}" class="btn btn-success" style="float: right;">Add Admin</a>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <td> <a href="{{route('admin.geadmin.edit',$ap->id)}}" class="btn btn-warning"><i class="fas fa-edit"></i></a></td>
                                        <td>
                                            <form action="{{ route('admin.geadmin.delete', $ap->id) }}" method="POST">
                                                @csrf
                                                @method('POST')
  ...
  <div>
    @else
    <tr> <STrong> <p>Admin not found</p></tr></STrong> </TR>
      @endif
   <script>
