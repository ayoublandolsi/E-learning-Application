...
<div class="container">
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                <img src="{{ asset('uploads/apprenant/'. $apprenants->img)}}"  class="card-img-top" alt="Student Image">
                <div class="card-body">
                    <h5 class="card-title">Student Name</h5>
                    <p class="card-text">Email: studentemail@example.com</p>
                    <p class="card-text">Phone: +1 123-456-7890</p>
                    <p class="card-text">Gender: Male</p>
                    <p class="card-text">Groupe: ffff</p>
