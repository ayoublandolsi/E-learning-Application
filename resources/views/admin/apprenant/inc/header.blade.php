...
<nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="{{route ('admin.apprenant.index')}}" class="nav-item nav-link active">Home</a>
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-down m-0">
                        <a href="{{route ('admin.geadmin.index')}}" class="dropdown-item">Admin Management</a>
                        <a href="{{route('admin.prof.index')}}" class="dropdown-item ">list of traines</a>
                        <a href="{{route('admin.apprenant.index')}}" class="dropdown-item ">Apprenant Management</a>
                        ...
                        <a href="{{route('admin.video.index')}}" class="dropdown-item ">Lesson Management</a>
                        <a href="{{route('admin.group.index')}}" class="dropdown-item ">Group Management</a>
                        <a href="{{route('admin.certificat.index')}}" class="dropdown-item ">Certificate Management</a>
