...
<body>
    ...
    <div class="search-container">
        ...
        <form style="margin-top: 50px;" class="form-inline" action="{{ route('admin.group.index') }}" method="GET">
...
<Div class="container mt-5">
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="{{ route('admin.group.create') }}" class="btn btn-success" style="float: right;">Add group</a>
                <div class="card-header">groupe List</div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.group.show',$ap->id)}}" class="btn btn-primary" class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
                                        <td> <a href="{{route('admin.group.edit',$ap->id)}}" class="btn btn-warning"><i class="fas fa-edit"></i></a></td>
                                        <td>
                                            <form action="{{ route('admin.group.delete', $ap->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
  ...
  <div>
    @else
    <tr> <STrong> <p>Group not found</p></tr></STrong> </TR>
      @endif
   <script>
