...
<body>
    ...
    <div class="search-container">
        ...
        <form style="margin-top: 50px;" class="form-inline" action="{{ route('admin.certificat.index') }}" method="GET">
...
<Div class="container mt-5">
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="{{ route('admin.certificat.create') }}" class="btn btn-success" style="float: right;">Add Certificat</a>
                <div class="card-header">Certificat List</div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <td> <a href="{{route('admin.certificat.edit',$ap->id)}}" class="btn btn-info"><i class="fas fa-edit"></i>Affecter certificat</a></td>

                                        <td> <a href="{{route('admin.certificat.edit',$ap->id)}}" class="btn btn-warning"><i class="fas fa-edit"></i></a></td>
                                        <td>
                                            <form action="{{ route('admin.certificat.delete', $ap->id) }}" method="POST">
                                                @csrf
                                                @method('POST')
                                            ...
                                            <script>
                                                window.deleteConfirm = function (e) {
                                                    ...
                                                    Swal.fire({
                                                        title: "Are you sure?",
                                                        text: "Once deleted, you will not be able to recover this specialite" + "{{ $ap->name }}" + "!",
                                                        icon: "warning",
                                                        ...
                                                        if (result.isConfirmed) {
                                                            Swal.fire({title: "Poof! Your imaginary file has been deleted!",
                                                                icon: "success",
  ...
  <div>
    @else
    <tr> <STrong> <p>certificat not found</p></tr></STrong> </TR>
      @endif
